...
public interface sqlVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link sqlParser#col_type}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCol_type(@NotNull sqlParser.Col_typeContext ctx);
	...
	/**
	 * Visit a parse tree produced by {@link sqlParser#sql_where}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by {@link sqlParser#foreign_col}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitForeign_col(@NotNull sqlParser.Foreign_colContext ctx);

	/**
	 * Visit a parse tree produced by {@link sqlParser#primary_col}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrimary_col(@NotNull sqlParser.Primary_colContext ctx);
