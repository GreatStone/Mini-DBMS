...
public class PropertiesFileManager {
	...
	private static void mergeDirctoryFullPath() {
		systemProperties.setProperty(
				"Log_LogFileDirctory",
				FileTool.openDirctory(
						PropertiesFileManager
								.getProperty("Sys_ApplicationLocation"),
						PropertiesFileManager
								.getProperty("Log_LogFileDirctory"))
						.getAbsolutePath());
		systemProperties.setProperty(
				"Dict_DataDictDirctory",
				FileTool.openDirctory(
						PropertiesFileManager
								.getProperty("Sys_ApplicationLocation"),
						PropertiesFileManager
		...
		systemProperties.setProperty(
				...
				FileTool.openDirctory(
						...
						.getAbsolutePath());
		systemProperties.setProperty(
				"Sys_TempFileDirctory",
				FileTool.openDirctory(
						PropertiesFileManager
								.getProperty("Sys_ApplicationLocation"),
						PropertiesFileManager
								.getProperty("Sys_TempFileDirctory"))
						.getAbsolutePath());
	}
	...
	private static void loadSystemProperties() {
		...
		if (systemProperties.getProperty("Sys_ApplicationLocation") == null) {
			systemProperties.setProperty("Sys_ApplicationLocation",
					applicationLocation);
		}
